...
//currently returning some undefineds, unsure why.
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const standardizePhoneNumbers = (arr) => {
  ...
  arr.forEach(string => {
    console.log(arr)
    console.log(string)
    slicedArray.push(string.slice(0,0))//.slice(4,5).slice(9,9))
    console.log(slicedArray, string)
  })
  console.log(slicedArray)
  return slicedArray
};
standardizePhoneNumbers(['(217) 649-7836'])
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
