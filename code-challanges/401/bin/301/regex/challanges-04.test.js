...
citiesAtoJ(['Cleveland', 'San Diego', 'Birmingham', 'Seattle', 'Miami', 'New York City', 'Omaha', 'Portland', 'Austin', 'Boston', 'Newport Beach', 'Hoboken'])
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const matchMonth = (input) => {
  return [/[(oct)]/, /[(october)]/, /[(October)]/, /[(Oct)]/].includes(input)?true:false;
};
